      ...
      <div className="mx-4 my-2 md:mx-6">
        <div className="mx-auto max-w-6xl px-4 py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="[text-shadow:0_0_3px_rgba(80,5,255,0.035),0_0_8px_rgba(80,5,255,0.01)] text-lg font-bold text-logo-color flex items-center gap-2 dark:[text-shadow:0_0_10px_rgba(88,187,246,0.36),0_0_24px_rgba(88,187,246,0.12)]">
               &gt;
              <Image
                src={star}
                alt="star"
